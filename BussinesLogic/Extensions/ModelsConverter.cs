...
using EFProduct = DataAccess.Entities.Product;
...
namespace ShopBussinesLogic.Extensions
{
    class ModelsConverter
    {
        ...
        public static BLProduct ConvertEFProduct(EFProduct product)
        {
            ...
            if(product.Count > 0)
            {
                result.State = ShopBussinesLogic.Models.ProductState.Processed;
            }
            else
            {
                result.State = ShopBussinesLogic.Models.ProductState.NotInStock;
            }
